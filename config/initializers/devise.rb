...
Devise.setup do |config|
  ...
  config.secret_key = 'd22eb97d432a2d38f85f83cdcc09cb6bcdc9c5439e0712
  fc3986e12e144b9de3b0561921340159c9d6c17
  e88f45759e06f3879bcd20e685193a7febeea4d25ec'

  # ==> Mailer Configuration
  # Configure the e-mail address which will be shown in Devise::Mailer,
  # note that it will be overwritten if you use your own mailer class
  # with default "from" parameter.
  config.mailer_sender = 'please-change-
  me-at-config-initializers-devise@example.com'
  ...
  # You can also supply a hash where the value is
  # a boolean determining whether
  # or not authentication should be aborted when the value is not present.
  config.authentication_keys = [:facebook_id]
  ...
  #  If using other encryptors, it sets how many
  #  times you want the password re-encrypted.
  ...
  # Note that, for bcrypt (the default encryptor),
  ...
  # config.pepper = 'b9a0bb3367087f704354f5f29479346f2b55f671
  # ca30c86aa289d6b7d7cb412255078674caa4a315a67b04eedaebfb0931
  # c096744c832c5d997d4df9d6755d3d'
  ...
  # way as initial account confirmation)
  ...
  # confirmation. config.reconfirmable = true
  ...
  # :none            = No lock strategy.
  # You should handle locking by yourself.
  ...
  # as :clearance_sha1, :authlogic_sha512
